...
- `4901`: 用户查询Worker升级时，指定Worker信息无法查询
- `4902`: 用户查询Worker升级时，指定Worker等级已经最高
- `4903`: 用户查询Worker升级时，指定Worker等级未注册升级额外需求，不可升级
- `4904`: 用户查询Worker升级时，额外升级物品需求详细信息获取失败
- `5001`: 用户升级Worker时，指定Worker信息无法查询
- `5002`: 用户升级Worker时，指定Worker等级已经最高
- `5003`: 用户升级Worker时，指定Worker等级未注册升级额外需求，不可升级
- `5004`: 用户升级Worker时，扣除积分时积分不足
- `~~5005~~`: ~~用户升级Worker时，扣除物品失败~~
- `5006`: 用户升级Worker时，更新Worker等级失败
- `5101`: 用户兑换礼包时，验证码输入错误
- `5102`: 用户兑换礼包时，礼包不存在或不在兑换时间内
- `5103`: 用户兑换礼包时，礼包已经过期
- `5104`: 用户兑换礼包时，无法查询已经兑换的礼包数量
- `5105`: 用户兑换礼包时，该礼包已经全部兑换完毕
- `5106`: 用户兑换礼包时，非该礼包指定兑换账户
- `~~5107~~`: ~~用户兑换礼包时，无法获取用户已有物品信息~~
- `5108`: 用户兑换礼包时，更新已有物品信息失败
- `5109`: 用户兑换礼包时，用户已经兑换过此礼包
- `5201`: 用户查询可挂售物品时，背包数据获取失败
- `~~5301~~`: ~~用户提交挂售时，背包数据获取失败~~
- `5302`: 用户提交挂售时，缺少挂售许可
- `5303`: 用户提交挂售时，指定物品数量不足
- `5304`: 用户提交挂售时，更新用户物品数据失败
- `5305`: 用户提交挂售时，提交挂售失败
- `5306`: 用户提交挂售时，提交了错误的数据
- `5307`: 用户提交挂售时，价格过低
- `5401`: 用户在交易市场购买时，提交了错误的数据
- `5402`: 用户在交易市场购买时，商品不存在或已经售罄
- `5403`: 用户在交易市场购买时，用户状态异常
- `5404`: 用户在交易市场购买时，剩余物品数量不足
- `5405`: 用户在交易市场购买时，积分不足
- `5406`: 用户在交易市场购买时，扣除积分失败
- `5407`: 用户在交易市场购买时，注册购买信息失败
- `5408`: 用户在交易市场购买时，增加卖家积分失败
- `5409`: 用户在交易市场购买时，购买超时
- `5410`: 用户在交易市场购买时，写入数据库失败
- `5411`: 用户在交易市场购买时，购买自己的商品
- `5501`: 用户在修改挂售物品单价时，提交了错误的数据
- `5502`: 用户在修改挂售物品单价时，无需修改、已经售罄或挂售不存在
- `5503`: 用户在修改挂售物品单价时，价格过低
- `5601`: 用户在下架挂售物品时，物品不存在或售罄或状态异常
- `5602`: 用户在下架挂售物品时，更新数据库失败
- `5603`: 用户在下架挂售物品时，退回物品失败
- `5701`: 用户在转移账户资产时，填写的验证码错误
- `5702`: 用户在转移账户资产时，填写的原账户密码不匹配或不存在
- `5703`: 用户在转移账户资产时，填写的新账户用户名不合法
- `5704`: 用户在转移账户资产时，填写的新账户密码不合法
- `5705`: 用户在转移账户资产时，新账户用户名已被使用
- `5706`: 用户在转移账户资产时，新用户信息写入数据库失败
- `5801`: 用户申请邮箱验证时，填写的验证码错误
- `5802`: 用户申请邮箱验证时，填写的邮箱错误
- `5803`: 用户申请邮箱验证时，邮箱已被占用
- `5804`: 用户申请邮箱验证时，账户状态异常
- `5805`: 用户申请邮箱验证时，此邮箱的验证码距离上次发送不足60秒
- `5806`: 用户申请邮箱验证时，注册此邮箱失败
- `5901`: 用户创建基金会议事大厅议题时，用户状态不为1或注册时间不满一周
- `5902`: 用户创建基金会议事大厅议题时，今日创建的话题大于等于5个
- `5903`: 用户创建基金会议事大厅议题时，类型错误
- `5904`: 用户创建基金会议事大厅议题时，创建话题失败
- `6001`: 用户回复基金会议事大厅议题时，用户状态不为1或注册时间不满一天
- `6002`: 用户回复基金会议事大厅议题时，用户距离上次回复不满30秒
- `6003`: 用户回复基金会议事大厅议题时，did不合法
- `6004`: 用户回复基金会议事大厅议题时，与上次评论重复
- `6005`: 用户回复基金会议事大厅议题时，不存在的或已经关闭的话题
- `6101`: 用户关闭基金会议事大厅议题时，did不合法
- `6102`: 用户关闭基金会议事大厅议题时，不是自己的话题或已经关闭或did不存在
- `6201`: 管理员基金会议事大厅议题状态时，did或status不合法
- `6301`: 用户修改昵称时，昵称已经存在
- `6302`: 用户修改昵称时，已经在一天内修改过账户信息
- `6303`: 用户修改昵称时，更新数据库失败
- `6401`: 用户领取新手礼包时，注册时间在一周外
- `6402`: 用户领取新手礼包时，已经领取过今日礼包
- `6501`: 用户在基金会捐赠积分时，捐赠数量不合法
- `6502`: 用户在基金会捐赠积分时，今日已经捐赠过
- `6503`: 用户在基金会捐赠积分时，积分不足
